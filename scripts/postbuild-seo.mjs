...
const servicePages = [
  ...
  createServicePage({
    ...
    heading: {
      ru: 'GIGA VPN через Telegram для компьютера и телефона',
      en: 'GIGA VPN through Telegram for desktop and mobile',
      es: 'GIGA VPN por Telegram para ordenador y móvil',
      zh: '通过 Telegram 使用 GIGA VPN',
      ko: 'Telegram을 통한 GIGA VPN',
    },
    intro: {
      ru: 'GIGA VPN запускается через Telegram-бота и даёт три бесплатных дня на проверку. Для подключения используется клиент Incy или Happ, поэтому одна подписка подходит для Windows, macOS, Android и iOS.',
      en: 'GIGA VPN starts through a Telegram bot and includes three free trial days. It connects through Incy or Happ on Windows, macOS, Android, and iOS.',
      es: 'GIGA VPN se activa mediante un bot de Telegram e incluye tres días de prueba. Se conecta con Incy o Happ en Windows, macOS, Android e iOS.',
      zh: 'GIGA VPN 通过 Telegram 机器人开通，并提供三天免费试用。可使用 Incy 或 Happ 连接 Windows、macOS、Android 和 iOS。',
      ko: 'GIGA VPN은 Telegram 봇에서 시작하며 3일 무료 체험을 제공합니다. Windows, macOS, Android, iOS에서 Incy 또는 Happ로 연결합니다.',
    },
    keywords: {
      ru: 'GIGA VPN обзор, GIGA VPN Telegram бот, VPN Incy, VPN Happ, VPN 3 дня бесплатно',
      en: 'GIGA VPN review, GIGA VPN Telegram bot, Incy VPN, Happ VPN, free VPN trial',
      es: 'GIGA VPN análisis, bot Telegram VPN, Incy VPN, Happ VPN, prueba VPN gratis',
      zh: 'GIGA VPN 评测, Telegram VPN 机器人, Incy VPN, Happ VPN, 免费 VPN 试用',
      ko: 'GIGA VPN 리뷰, Telegram VPN 봇, Incy VPN, Happ VPN, 무료 VPN 체험',
    },
    points: {
      ru: ['Telegram, зарубежные сайты, Gemini и Polymarket.', 'Три бесплатных дня для проверки.', 'Windows, macOS, Android и iOS.'],
      en: ['Telegram, international websites, Gemini, and Polymarket.', 'Three free trial days.', 'Windows, macOS, Android, and iOS.'],
      es: ['Telegram, sitios internacionales, Gemini y Polymarket.', 'Tres días de prueba gratis.', 'Windows, macOS, Android e iOS.'],
      zh: ['适用于 Telegram、海外网站、Gemini 和 Polymarket。', '三天免费试用。', '支持 Windows、macOS、Android 和 iOS。'],
      ko: ['Telegram, 해외 웹사이트, Gemini 및 Polymarket.', '3일 무료 체험.', 'Windows, macOS, Android 및 iOS.'],
    },
    items: {
      ru: ['Для подключения понадобится Incy или Happ.', 'Сервис рекомендует Incy как более стабильный вариант.', 'Актуальные тарифы и страны лучше проверить в боте.'],
      en: ['Incy or Happ is required.', 'The service recommends Incy as the more stable option.', 'Check current plans and locations in the bot.'],
      es: ['Se necesita Incy o Happ.', 'El servicio recomienda Incy como opción más estable.', 'Comprueba tarifas y países en el bot.'],
      zh: ['需要使用 Incy 或 Happ。', '服务方推荐更稳定的 Incy。', '请在机器人中查看当前套餐和地区。'],
      ko: ['Incy 또는 Happ가 필요합니다.', '서비스는 더 안정적인 Incy를 권장합니다.', '현재 요금제와 지역은 봇에서 확인하세요.'],
    },
  }),
  createServicePage({
    id: 'tochka-g',
  ...
  createServicePage({
    id: 'guide-best-mobile-proxies',
    type: 'article',
    russianOnly: true,
    route: '/proxy-vpn/luchshie-mobilnye-proksi',
    name: 'Лучшие мобильные прокси',
    logo: '/logo.png',
    title: { ru: 'Лучшие мобильные прокси 2026: сравнение сервисов | Hopscup Tools' },
    description: { ru: 'Сравнение MobileProxy, ProxyWing и Proxy-Seller: GEO, ротация IP, трафик, цены, ограничения и промокоды на мобильные прокси.' },
    heading: { ru: 'Лучшие мобильные прокси в 2026 году' },
    intro: { ru: 'Практическое сравнение трёх сервисов и честный разбор ситуаций, когда мобильный IP оправдывает цену, а когда достаточно обычного IPv4.' },
    keywords: { ru: 'лучшие мобильные прокси, купить мобильные прокси, рейтинг мобильных прокси, мобильные прокси 4G 5G' },
    points: { ru: ['MobileProxy из личного опыта более трёх лет.', 'ProxyWing с короткими тарифами.', 'Proxy-Seller с выбором формата и оператора.'] },
    items: { ru: ['Модели оплаты и ротация IP.', 'Безлимитный трафик и одновременные подключения.', 'Когда мобильный прокси выгоднее IPv4.'] },
  }),
